...
if __name__ == "__main__":
    logger.info("UNESDOC collector starting...")
    session = create_db_session()
    corpus: Corpus | None = (
        session.query(Corpus).filter_by(source_name="unesdoc").one_or_none()
    )
    ...
    urls = unesdoc_collector.collect()
    ...
    logger.info("UNESDOC collector ended")
