...
def main() -> None:
    logger.info("QdrantSyncronizer generate batch ids starting...")
    ...
    if size_limit_str is not None:
        ...
        logger.info("Size limit set to %s bytes", size_limit)
    ...
    logger.info("QdrantSyncronizer generate batch ids finished")
