...
def main() -> None:
    logger.info("GenerateToCleanBatch generate batch ids starting...")
    ...
    ids_to_batch = retrieve_data_from_database.retrieve_random_documents_ids_according_process_title(
        db_session,
        qty_max=qty_max,
    ...
    logger.info("%s generate batch ids finished", __name__)
